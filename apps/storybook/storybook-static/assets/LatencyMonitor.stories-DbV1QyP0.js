import{j as a}from"./jsx-runtime-u17CrQMm.js";import{r as i}from"./iframe-CV-5FfhP.js";import{L as o}from"./LatencyMonitor-CuLSs1u-.js";import{u as e}from"./useLooperStore-Dw-zsQq8.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B8eWrQ5m.js";import"./ArrowsClockwise.es-vnVStLo6.js";import"./IconBase.es-DSmtO-o_.js";import"./Lightning.es-BzvzFfQf.js";import"./useDialogStore-ddHqeGHH.js";const b={title:"Web/LatencyMonitor",component:o,tags:["ai-generated"],decorators:[t=>a.jsx("div",{style:{position:"relative",minHeight:"250px",width:"100%"},children:a.jsx(t,{})})]},n={render:()=>(i.useEffect(()=>{e.setState({latencyMeasuredSamples:0,latencyCompensationSamples:0,isCalibratingLatency:!1,jitter:0,calibrateLatency:()=>{e.setState({isCalibratingLatency:!0}),setTimeout(()=>{e.setState({isCalibratingLatency:!1,latencyMeasuredSamples:529,latencyCompensationSamples:529,jitter:4e-4})},2e3)}})},[]),a.jsx(o,{}))},r={render:()=>(i.useEffect(()=>{e.setState({latencyMeasuredSamples:441,latencyCompensationSamples:441,isCalibratingLatency:!1,jitter:6e-4});const t=setInterval(()=>{e.setState({jitter:5e-4+3e-4*Math.random()})},500);return()=>clearInterval(t)},[]),a.jsx(o,{}))},s={render:()=>(i.useEffect(()=>{e.setState({latencyMeasuredSamples:882,latencyCompensationSamples:882,isCalibratingLatency:!1,jitter:.0045});const t=setInterval(()=>{e.setState({jitter:.003+.003*Math.random()})},300);return()=>clearInterval(t)},[]),a.jsx(o,{}))};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => {
    useEffect(() => {

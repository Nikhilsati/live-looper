import{j as l}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-DjrwvunH.js";import{K as o}from"./index-P_MXkEvz.js";import"./preload-helper-PPVm8Dsz.js";const g={title:"UI/Knob",component:o,tags:["ai-generated"],argTypes:{color:{control:"color"},size:{control:{type:"range",min:30,max:120,step:5}},min:{control:"number"},max:{control:"number"},step:{control:"number"},unit:{control:"text"},label:{control:"text"}}},r={args:{min:0,max:100,label:"Volume",color:"#f97316",size:60,step:1,unit:"%"},render:e=>{const[n,a]=c.useState(50);return l.jsx(o,{...e,value:n,onChange:a})}},t={args:{min:-50,max:50,label:"Pan",color:"#10b981",size:50,step:1,unit:""},render:e=>{const[n,a]=c.useState(0);return l.jsx(o,{...e,value:n,onChange:a})}},s={args:{min:0,max:1,label:"Feedback",color:"#a78bfa",size:70,step:.01,unit:""},render:e=>{const[n,a]=c.useState(.5);return l.jsx(o,{...e,value:n,onChange:a})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    min: 0,
    max: 100,
    label: "Volume",

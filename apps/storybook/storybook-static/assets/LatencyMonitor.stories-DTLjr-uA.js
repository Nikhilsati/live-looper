import{j as a}from"./jsx-runtime-u17CrQMm.js";import{r as i}from"./iframe-CuidZOye.js";import{L as o}from"./LatencyMonitor-ClHM5nP6.js";import{u as e}from"./useLooperStore-Dc0igdZd.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CzRv-HbD.js";import"./ArrowsClockwise.es-naLBFEc2.js";import"./IconBase.es-CuMwx6Nm.js";import"./Lightning.es-FXVKR3hU.js";import"./useDialogStore-BNH4vANE.js";const b={title:"Web/LatencyMonitor",component:o,tags:["ai-generated"],decorators:[t=>a.jsx("div",{style:{position:"relative",minHeight:"250px",width:"100%"},children:a.jsx(t,{})})]},n={render:()=>(i.useEffect(()=>{e.setState({latencyMeasuredSamples:0,latencyCompensationSamples:0,isCalibratingLatency:!1,jitter:0,calibrateLatency:()=>{e.setState({isCalibratingLatency:!0}),setTimeout(()=>{e.setState({isCalibratingLatency:!1,latencyMeasuredSamples:529,latencyCompensationSamples:529,jitter:4e-4})},2e3)}})},[]),a.jsx(o,{}))},r={render:()=>(i.useEffect(()=>{e.setState({latencyMeasuredSamples:441,latencyCompensationSamples:441,isCalibratingLatency:!1,jitter:6e-4});const t=setInterval(()=>{e.setState({jitter:5e-4+3e-4*Math.random()})},500);return()=>clearInterval(t)},[]),a.jsx(o,{}))},s={render:()=>(i.useEffect(()=>{e.setState({latencyMeasuredSamples:882,latencyCompensationSamples:882,isCalibratingLatency:!1,jitter:.0045});const t=setInterval(()=>{e.setState({jitter:.003+.003*Math.random()})},300);return()=>clearInterval(t)},[]),a.jsx(o,{}))};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => {
    useEffect(() => {

...
const ICON_GROUPS = {
  ...
  Mixing: ["WaveformIcon", "MetronomeIcon", "EqIcon", "MixerIcon", "GainIcon"],
  Effects: [
    "CompressorIcon",
    "LimiterIcon",
    "GateIcon",
  ...
  Timing: ["TempoIcon", "TimeSignatureIcon", "QuantizeIcon", "GrooveIcon"],
  Arrangement: [
    "ClipIcon",
    "FadeInIcon",
    "FadeOutIcon",
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 p-8 font-sans">
      ...
      <section className="mt-16 pt-8 border-t border-zinc-800">
        ...
        <div className="flex flex-wrap gap-8">
          ...
          <div className="flex flex-col items-center gap-2">
            <Icons.MixerIcon
              className="text-indigo-400 stroke-[3px]"
              width={48}
              height={48}
            />

        ...
        <div style={{
            ...
            <div style={{ display: 'flex', gap: 6, alignItems: 'end', height: 16 }}>
                {inputLevels.map((level, i) => {
                    ...
                    return (
                        <div key={i} style={{ width: 6, height: '100%', background: 'rgba(255,255,255,0.05)', borderRadius: 1, position: 'relative', overflow: 'hidden' }}>
                            <div 
                                style={{ 
                                    position: 'absolute',
                                    bottom: 0,
                                    ...
                                    boxShadow: isPeaking ? '0 0 8px #ef4444' : `0 0 4px ${color}80`,
            ...
            <span style={{ fontSize: 9, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.2em', color: 'rgba(255,255,255,0.15)' }}>Monitor</span>
        </div>
    );
};

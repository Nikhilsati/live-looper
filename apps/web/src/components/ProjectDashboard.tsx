...
import { PlusIcon, DownloadSimpleIcon, UploadSimpleIcon, TrashIcon, MusicNoteIcon, ClockIcon, VinylRecordIcon, GuitarIcon, LightningIcon } from '@phosphor-icons/react';
            ...
            <Stack style={{ maxWidth: 1200, margin: '0 auto', gap: 60 }}>
                ...
                <div
                    ...
                    style={{
                        position: 'relative',
                        padding: '28px 32px',
                        background: 'linear-gradient(135deg, rgba(16,185,129,0.1) 0%, rgba(8,145,178,0.08) 100%)',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 20, zIndex: 1 }}>
                        ...
                        <div>
                            ...
                            <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', fontWeight: 400 }}>
                                Plug in and play — live pass-through with the full FX rack. No project needed.
                            </div>
                        </div>
                    </div>

...
export const DevInspector: React.FC = () => {
    const { currentProject, tracks: storeTracksState, sections, bpm, mode } = useLooperStore();
    ...
    const playLayer = useCallback(async (layer: LayerRecord, blob: AudioBlobRecord) => {
        ...
        <div style={{ marginTop: 24 }}>
            ...
            <button
                ...
                style={{
                    ...
                    borderRadius: 8,
                    color: open ? '#a5b4fc' : 'rgba(255,255,255,0.4)',
                    fontSize: 12,
                    fontWeight: 600,
                    cursor: 'pointer',
            ...
            >
                ...
                <span style={{
                    ...
                    color: open ? '#c7d2fe' : 'rgba(255,255,255,0.3)',
                }}>
                    {open ? 'OPEN' : 'CLOSED'}
                </span>
            </button>
                                                    ...
                                                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 11 }}>
                                                        ...
                                                        <tbody>
                                                            {snap.layers.map((layer) => {
                                                                ...
                                                                const estimatedSize = blob ? blob.lengthSamples * 2 : 0;
                                                                const isThisPlaying = playingLayerId === layer.id;
                                                                const isThisLoading = loadingLayerId === layer.id;
                                                                const isAnotherPlaying = (!!playingLayerId && !isThisPlaying) || !!playingTrackId;
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <td style={{ padding: '5px 8px' }}>
                                                                            <PlayBtn
                                                                                ...
                                                                                onPlay={() => blob && playLayer(layer, blob)}
                                                                                onStop={stopCurrent}
                                                                            />
                                                                        </td>
                                                                        ...
                                                                        <td style={{ padding: '5px 8px', color: '#7c3aed', fontFamily: 'monospace' }}>
                                                                            {blob ? shortId(blob.id) : <span style={{ color: '#ef4444' }}>missing!</span>}
                                                                        </td>

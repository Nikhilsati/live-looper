      ...
      <Stack style={{ gap: "14px" }}>
        <Row style={{ justifyContent: "space-between", alignItems: "center" }}>
          <Row style={{ alignItems: "center", gap: "8px" }}>
            ...
            <Heading
              style={{ fontSize: "14px", margin: 0, letterSpacing: "0.02em" }}
            >
              Performance
            </Heading>
          </Row>
        ...
        <Grid cols="1fr 1fr" style={{ gap: "20px" }}>
          ...
          <Stack style={{ gap: "12px" }}>
            <Stack style={{ gap: "4px" }}>
              <Label style={{ fontSize: "11px", opacity: 0.6 }}>
        ...
        {measuredMs === 0 && (
          ...
          >
            ...
            >
              <strong>Calibration Required:</strong> Place your microphone near
              your speaker and hit Calibrate for sample-accurate loops.
            </Text>
          </Row>
        )}
      </Stack>
